# ScaffoldSeal-CP v0.8.0

## Release title

Journal of Cheminformatics reproducibility package.
...
- Added a combined environment entry point and a step-by-step reproducibility guide.
- Updated release metadata to version 0.8.0.
- Retained the existing third-party data non-redistribution boundary.
