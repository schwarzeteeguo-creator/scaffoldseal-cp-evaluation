# Journal of Cheminformatics 投稿文件说明
...
- 增加不超过三句的 `Scientific Contribution`。
- 使用 3--10 个关键词、编号章节、数字编号参考文献和黑色链接。
- 增加缩写表。
...
Journal of Cheminformatics 要求支撑论文结论的数据、软件和算法可由第三方完全复现，并且不得要求注册、登录或接受超出 Creative Commons（数据/文本）或 OSI 认可开源许可（软件）的条款。当前包未再分发上游逐条结构和通透性标签，因为尚未确认其再分发许可；这可能成为编辑初筛问题。投稿前应确认 CycPeptMPDB 原始下载是否无需登录且许可符合要求，或取得可再分发许可并将必要数据以机器可读形式归档。

请所有作者在提交前确认作者顺序、单位、贡献、基金号、无利益冲突声明及对致谢对象的署名许可。
